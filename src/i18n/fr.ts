export const fr = {
  ...
  homeServices: {
    ...
    description: "Nous vous offrons des solutions sur mesure pour gérer efficacement vos processus. Que ce soit pour suivre vos projets, organiser vos données, ou automatiser certaines tâches, nous vous accompagnons à chaque étape.",
    learnMore: "Découvrir",
  ...
  services: {
    ...
    webDevDesc: "Création de sites web modernes, rapides, sécurisés et adaptés aux besoins de votre activité.",
    mobileDev: "Développement Mobile",
    mobileDevDesc: "Conception d’applications mobiles performantes, intuitives et adaptées à vos utilisateurs.",
    erp: "Solutions ERP",
    erpDesc: "Solutions sur mesure pour centraliser vos données, automatiser vos tâches et optimiser vos processus.",
    cloudHosting: "Solutions Cloud et Hébergement",
    cloudHostingDesc: "Infrastructure cloud, hébergement sécurisé et solutions fiables pour accompagner votre croissance.",
  },
  ...
  megaMenu: {
    // Services
    webDev: "Développement Web",
    webDevDesc: "Création de sites web modernes, rapides et adaptés à votre activité.",
    mobileDev: "Développement Mobile",
    mobileDevDesc: "Conception d’applications mobiles performantes et intuitives.",
    erp: "Solutions ERP",
    erpDesc: "Solutions sur mesure pour centraliser vos données et automatiser vos processus.",
    cloudHosting: "Solutions Cloud et Hébergement",
    cloudHostingDesc: "Infrastructure cloud et hébergement sécurisé pour accompagner votre croissance.",
