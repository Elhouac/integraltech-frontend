export const fr = {
  ...
  services: {
    cybersecurity: "Cybersécurité & Conformité",
    cybersecurityDesc: "Audit de sécurité, protection des réseaux, gestion des accès et conformité (ISO 27001, CNDP).",
    cloudInfra: "Cloud & Infrastructure",
    cloudInfraDesc: "Migration cloud, hébergement haute disponibilité, virtualisation et infrastructures hybrides.",
    erp: "Solutions ERP & CRM",
    erpDesc: "Déploiement et intégration de progiciels de gestion pour optimiser vos processus métiers.",
    techSupport: "Support & Maintenance IT",
    techSupportDesc: "Assistance technique réactive 24/7, infogérance et maintenance préventive de vos systèmes.",
    bi: "Business Intelligence & Analytics",
    biDesc: "Tableaux de bord interactifs, analyse de données et outils de pilotage décisionnel pour l'entreprise.",
    itConsulting: "Conseil & Audit IT",
    itConsultingDesc: "Accompagnement stratégique, schéma directeur informatique, gouvernance IT et optimisation des coûts.",
  },
  ...
  megaMenu: {
    // Services
    cybersecurity: "Cybersécurité & Conformité",
    cybersecurityShort: "Audit, protection des réseaux, gestion des accès et conformité (ISO 27001, CNDP).",
    cloudInfra: "Cloud & Infrastructure",
    cloudInfraShort: "Migration cloud, hébergement haute disponibilité et gestion d'infrastructures hybrides.",
    erp: "Solutions ERP & CRM",
    erpShort: "Déploiement et intégration de progiciels de gestion pour optimiser vos processus métiers.",
    techSupport: "Support & Maintenance IT",
    techSupportShort: "Assistance technique réactive 24/7, infogérance et maintenance préventive.",
    bi: "Business Intelligence & Analytics",
    biShort: "Tableaux de bord interactifs, analyse de données et outils de pilotage décisionnel.",
    itConsulting: "Conseil & Audit IT",
    itConsultingShort: "Accompagnement stratégique, schéma directeur informatique et gouvernance IT.",
