...
export const MOCK_ADMIN_AUDIT_EVENTS: AdminAuditEvent[] = [
  {
    ...
    resourceType: "service",
    resourceId: 101,
    resourceLabel: "Développement Web Sur Mesure",
    description: "Création d'un nouveau service dans le catalogue démonstration.",
    severity: "info",
    outcome: "success",
    source: "demo_seed",
    changes: [
      { field: "name", label: "Nom du service", before: "-", after: "Développement Web Sur Mesure" },
      { field: "status", label: "Statut initial", before: "-", after: "draft" },
    ],
    metadata: [
      { label: "Slug", value: "developpement-web-sur-mesure" },
