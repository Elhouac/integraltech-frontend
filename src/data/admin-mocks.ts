...
export const MOCK_ADMIN_AUDIT_EVENTS: AdminAuditEvent[] = [
  {
    ...
    source: "demo_seed",
    changes: [
      { field: "name", label: "Nom du service", before: "-", after: "Audit & Sécurité Informatique" },
      { field: "status", label: "Statut initial", before: "-", after: "active" },
    ],
    metadata: [
      { label: "Catégorie", value: "Cybersécurité" },
  ...
  },
  {
    id: 702,
    actorUserId: 2,
    actorDisplayName: "Fatima Benali",
    actorRole: "editor",
    ...
    metadata: [
      { label: "Demandeur", value: "Fatima Benali (Éditeur)" },
    ],
    ipLabel: "198.51.100.xxx",
  ...
  },
  {
    ...
    resourceType: "post",
    resourceId: 201,
    resourceLabel: "Guide de Cybersécurité 2026",
    description: "Mise à jour des métadonnées multilingues de l'article.",
    severity: "info",
    outcome: "success",
    source: "demo_seed",
    changes: [
      { field: "title_fr", label: "Titre FR", before: "Guide Cybersécurité", after: "Guide de Cybersécurité 2026" },
    ],
    ipLabel: "198.51.100.xxx",
    deviceLabel: "MacBook Pro (Firefox)",
    sessionLabel: "Session démonstration",
